  ...
  return (
    <main className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <h1 className="text-4xl font-bold mb-2 text-roast">Track Your Order</h1>
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-lg p-8 mb-12">
          <div className="flex gap-4">
            ...
            <button
              ...
              className="bg-ember hover:bg-orange-700 text-white px-6 py-2 rounded transition"
            >
              Search
            </button>
          </div>
        ...
        {foundOrder && (
          <div className="border border-gray-300 rounded-lg p-8">
            <div className="flex justify-between items-start mb-6">
              <div>
                <h2 className="text-2xl font-bold text-roast">Order {foundOrder.id}</h2>
        ...
        {searchId && !foundOrder && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-6">
            <p className="text-red-800">No order found with ID: {searchId}</p>
            <p className="text-sm text-red-700 mt-2">Try: ER-10042, ER-10038, ER-10045, ER-10031, ER-10050</p>
          </div>
        )}
      </div>
    </main>
